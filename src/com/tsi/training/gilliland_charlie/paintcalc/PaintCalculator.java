...
public class PaintCalculator {
    public static void main(String[] args){
        ...
        float areaNotCoveredInMetersSq = GetAreaNotCovered(input, totalArea);
    ...
    public static float[][] GetWallDimensions(Scanner input, int noOfWalls){
    ...
    public static float GetAreaNotCovered(Scanner input, float totalArea) {
